    ...
    <div style={{ minHeight: "100vh", background: "linear-gradient(135deg, #0f0f23 0%, #1a1a3e 50%, #0d1b2a 100%)", color: "#fff", fontFamily: "system-ui, sans-serif", padding: "2rem" }}>
      <div style={{ maxWidth: "800px", margin: "0 auto", paddingTop: "2rem" }}>
        ...
        <div style={{ lineHeight: "1.8", fontSize: "1.05rem", color: "#d1d5db" }}>
          <p>If you're still copying data between apps, manually sending the same types of emails, or spending time on tasks that follow a predictable pattern, you're leaving hours on the table every week. <a href="https://make.com" rel="noopener sponsored" style={{ color: "#00d4ff" }}>Make.com</a> is a visual automation platform that lets you connect virtually any app to any other app and build workflows — called "scenarios" — that run automatically. No code required. This guide walks you through the core concepts and three real workflows you can build in under an hour.</p>
...
// Runs automatically whenever a matching email arrives`}</pre>
  ...
  → [Gmail: Send to team@company.com]`}</pre>
          ...
          <p><a href="https://make.com" rel="noopener sponsored" style={{ color: "#00d4ff" }}>Make.com</a> is the automation platform this entire guide is built around — it's the most visually intuitive no-code automation tool available, and the free tier is genuinely useful for getting started. If your workflows involve a lot of AI-generated content at scale, <a href="https://jasper.ai" rel="noopener sponsored" style={{ color: "#00d4ff" }}>Jasper</a> integrates with Make and provides a more polished content generation experience with brand voice controls and SEO optimization built in.</p>
