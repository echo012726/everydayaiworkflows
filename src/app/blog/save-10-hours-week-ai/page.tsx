    ...
    <div style={{ minHeight: "100vh", background: "linear-gradient(135deg, #0f0f23 0%, #1a1a3e 50%, #0d1b2a 100%)", color: "#fff", fontFamily: "system-ui, sans-serif", padding: "2rem" }}>
      <div style={{ maxWidth: "800px", margin: "0 auto", paddingTop: "2rem" }}>
        ...
        <div style={{ lineHeight: "1.8", fontSize: "1.05rem", color: "#d1d5db" }}>
          ...
          <pre style={{ background: "rgba(255,255,255,0.05)", border: "1px solid #374151", borderRadius: "8px", padding: "1rem", overflowX: "auto", fontSize: "0.9rem", color: "#a5f3fc" }}>{`Here are 8 emails I need to respond to. For each one:
...
[paste emails]`}</pre>
          <p>I review the drafts, edit maybe 20% of them, and send. What used to take 3.5 hours now takes about 45 minutes. Time saved: 2.75 hours.</p>
          ...
          <pre style={{ background: "rgba(255,255,255,0.05)", border: "1px solid #374151", borderRadius: "8px", padding: "1rem", overflowX: "auto", fontSize: "0.9rem", color: "#a5f3fc" }}>{`Meeting notes (rough):
[paste notes]
...
Format for easy copy-paste into Notion.`}</pre>
          <p>Total time savings on meeting overhead: about 2 hours per week.</p>
          ...
          <p>My workflow now: I keep a running daily log in Notion (just bullet points — takes 2 minutes at end of day). At the end of the week, I paste the week's log into Claude with this prompt:</p>
          <pre style={{ background: "rgba(255,255,255,0.05)", border: "1px solid #374151", borderRadius: "8px", padding: "1rem", overflowX: "auto", fontSize: "0.9rem", color: "#a5f3fc" }}>{`Here is my work log for this week:
[paste log]
...
Keep it under 250 words. Professional but not stiff.`}</pre>
          <p>Time saved: about 1 hour per week.</p>

          <h2 style={{ fontSize: "1.5rem", color: "#fff", marginTop: "2rem", marginBottom: "1rem", borderBottom: "1px solid #374151", paddingBottom: "0.5rem" }}>Hour Savings 10: Miscellaneous Writing</h2>
          ...
          <p>The tool matters less than the habit. Whether you use Claude, ChatGPT, or something else, the leverage comes from consistent use on the specific tasks that eat your time — not from occasional experiments when you remember to try it.</p>
