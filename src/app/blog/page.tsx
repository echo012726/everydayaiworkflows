...
const allPosts = [
  ...
  { slug: 'add-new-blog-post-about-ai-in-sales', title: 'AI in Sales: How Top Reps Are Closing More Deals Without Working More Hours', excerpt: 'How modern sales teams use AI for pre-call research, cold outreach, CRM automation, and objection handling — without burning out.', date: '2026-04-15', category: 'Sales', readingTime: '8 min' },
  ...
  { slug: 'boost-productivity-with-ai', title: '5 Proven Ways to Boost Productivity with AI', excerpt: 'Practical AI workflows — from morning brain dumps to email batching — that reclaim hours from your day without extra effort.', date: '2026-03-10', category: 'Productivity', readingTime: '8 min' },
