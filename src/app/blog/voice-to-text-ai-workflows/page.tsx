...
- Tags: [list 2-3 topic tags]`}</pre>
          ...
          <p>The setup with <a href="https://make.com" rel="noopener sponsored" style={{ color: "#00d4ff" }}>Make.com</a>:</p>
          <ul style={{ paddingLeft: "1.5rem", marginBottom: "1rem" }}>
...
Transcript: [paste]`}</pre>
          ...
          <div style={{ background: "rgba(0, 212, 255, 0.05)", border: "1px solid rgba(0, 212, 255, 0.2)", borderRadius: "12px", padding: "1.25rem", marginTop: "2rem", marginBottom: "2rem" }}>
            <p style={{ margin: 0, color: "#a5f3fc" }}>
              💡 <strong>The full pipeline:</strong> Voice memo → Whisper transcription → Claude structuring → Notion storage. Once this is running via <a href="https://make.com" rel="noopener sponsored" style={{ color: "#00d4ff" }}>Make.com</a>, ideas you capture on a walk are in your knowledge base before you get home. <a href="/tools" style={{ color: "#00d4ff" }}>See all recommended tools →</a>
            </p>
          </div>
